...
class ChartComponent extends React.Component {
    ...
    render() {
        return (
            <div id="chart-area">
                <ButtonGroup> 
                    <Button id="chart-help" variant="contained"  style={{"fontSize": "12px"}} color="primary" onClick={() => this.handleHelp()}><HelpIcon /></Button>
                    <Button id="show-cases" variant="contained" style={{"fontSize": "12px"}} color={this.state.show_cases ? "primary" : "default"} onClick={(e) => this.handleToggle("toggle-cases")}>Total cases</Button>
                    <Button id="show-hospital" variant="contained" style={{"fontSize": "12px"}} color={this.state.show_hospital ? "primary" : "default"}onClick={(e) => this.handleToggle("toggle-hospital")}>All hospitalizations</Button>
                    <Button id="show-critical" variant="contained" style={{"fontSize": "12px"}} color={this.state.show_critical ? "primary" : "default"} onClick={(e) => this.handleToggle("toggle-critical")}>Critical hospitalizations</Button>
                    <Button id="show-deaths" variant="contained" style={{"fontSize": "12px"}} color={this.state.show_deaths ? "primary" : "default"} onClick={(e) => this.handleToggle("toggle-deaths")}>Total deaths</Button>
                    <Button id="show-infectuous" variant="contained" style={{"fontSize": "12px"}} color={this.state.show_infectuous ? "primary" : "default"} onClick={(e) => this.handleToggle("toggle-infectuous")}>Infectious Cases</Button>
                    <Button id="show-rate" variant="contained" style={{"ffontSize": "12px"}} color={this.state.show_rate ? "primary" : "default"} onClick={(e) => this.handleToggle("toggle-rate")}>Reproduction rate</Button>
                    <Button id="show-ci" variant="contained" style={{"fontSize": "12px"}} color="secondary" onClick={(e) => this.handleToggle("toggle-ci")}>{this.state.show_ci ? 'HIDE CONFIDENCE INTERVALS' : 'SHOW CONFIDENCE INTERVALS'}</Button>
                </ButtonGroup>
